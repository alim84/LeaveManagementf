          ...
          <tbody>
            {leave.map((category, index) => (
              <tr key={index} className="border-b">
                ...
                <td className="px-4 py-2">{category.designation}</td>
                <td className="px-4 py-2">{category.institute}</td>
                <td className="px-4 py-2">{category.from}</td>
                <td className="px-4 py-2">{category.to}</td>
                <td className="px-4 py-2">{category.country}</td>
                <td className="px-4 py-2">{category.category}</td>
                <td className="px-4 py-2">{category.finance}</td>
